class Dog:
    ...
    # This is an accessor method that returns the speakText stored in the object. Notice that "self" is a parameter. Every method has "self" as its first parameter.
    # The "self" parameter is a reference to the current object. The current object appears on the left side of the the dot. (i.e the .) when the method is called.
    def speak(self):
    ...
    # This is another accessor method that uses the birthday information to return a string representing th date.
    def birthDate(self):
    ...
    def main():
        boyDog = Dog("Messa",5,15,2004,"WOOOOF")
