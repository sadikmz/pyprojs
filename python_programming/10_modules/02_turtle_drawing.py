...
def main() :
    ...
    # The following for loop reads the lines of the file, one at a time and executes teh body of teh loop once for each line of the file.
    for line in file:
        # The strip method strips off the newline character at the end of the line and any blanks that might be at the beginning or end of the line.
        text = line.strip()

        # # The following line splits the text variable into its pieces. For instance, if text contained "goto, 10, 20,1, black" then commandList will be equal to ["goto", "10", "20","1", "black"] after splitting text.
        ...
        if command == "goto" :
            # Writing float(commandList[1]) makes a float object out of the string found in commandList[1]. You can do similar conversion between types for int objects
