...
# The body of the loop is executed once for each line in the file.
for line in file :
...
# Closing the file is always a good idea, but it will be closed when your program terminates if you do not close it explicitly.
