...
fname_vehicle='data/vehicles.csv'
fname_update_status='data/update_status.csv'
fnames = fname_personal,fname_employment,fname_vehicle,fname_update_status


# Parser
persona_parser = (str,str,str,str,str)
employment_parser = (str,str,str,str)
vehicle_parser = (str,str,str,int)
update_status_parser = (str,parse_date,parse_date)
parser = persona_parser, employment_parser, vehicle_parser, update_status_parser
...
# compress_fields = (personal_fields_compress, employment_fields_compress, vehicle_fields_compress,
